...
Our system involves two types of processes: storage processes and handlers. The storage nodes are responsible for the primary data storage in the system
